...
if SplitHorizon == "NoSplitHorizon":
	ns.core.Config.SetDefault ("ns3::Ipv4GlobalRouting::RespondToInterfaceEvents", ns.core.EnumValue (ns.internet.RipNg.NO_SPLIT_HORIZON))

elif SplitHorizon == "SplitHorizon":
	ns.core.Config.SetDefault ("ns3::Ipv4GlobalRouting::RespondToInterfaceEvents", ns.core.EnumValue (ns.internet.RipNg.SPLIT_HORIZON))

else:
	ns.core.Config.SetDefault ("ns3::Ipv4GlobalRouting::RespondToInterfaceEvents", ns.core.EnumValue (ns.internet.RipNg.POISON_REVERSE))
